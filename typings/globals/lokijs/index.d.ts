...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/cd4debea25a280da0808d4ff2ca5a4bdb34bd28b/lokijs/index.d.ts
...
interface LokiCollection<E> extends LokiEventEmitter {
     ...
     */
    findOne(query: LokiQuery): E | null;
     ...
     */
    find(): E[];
    find(query: LokiQuery): LokiResultset<E> | void[];
